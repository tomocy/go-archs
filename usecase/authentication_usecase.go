...
func NewAuthenticationUsecase(userRepo repository.UserRepository, hashService service.HashService, sessService service.SessionService) AuthenticationUsecase {
